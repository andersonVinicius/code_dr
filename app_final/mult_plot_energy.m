...
for id_grid = 1:length(config_grid)
    ...
    path_naive = strcat('data_naive/',config_grid{id_grid},'_consumerEnergyUavForMissionQLeNaive.csv');
    path_sarsa = strcat('data_sarsa/',config_grid{id_grid},'_x_',config_grid{id_grid},'consumerEnergyUavForMissionQLeSarsa.csv');
    path_egreedy = strcat('data_egreedy/',config_grid{id_grid},'_x_',config_grid{id_grid},'_consumerEnergyUavForMissionQLe.csv');
    path_simple_ql = strcat('data_simple_ql/',config_grid{id_grid},'_x_',config_grid{id_grid},'_consumerEnergyUavForMissionQLeSarsa.csv');
